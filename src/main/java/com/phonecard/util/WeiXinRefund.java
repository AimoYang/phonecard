...
public class WeiXinRefund {
	 ...
	 */
	public Object refund(String out_trade_no,String out_refund_no,String total_fee,String refund_fee) throws Exception {
		...
		refund_fee = String.valueOf((int) (ArithUtil.mul(Double.parseDouble(total_fee), 100d)));
